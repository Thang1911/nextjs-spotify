...
export default function Playlist({ globalPlaylistId, setCurrentSongId, setPlaying }) {
  ...
  function changeOpacity(value) {
    ...
    const textOffset = 10;
    if(value < offset){
      const newOpacity = 1 -(offset - value)/offset;
      setOpacity(newOpacity);
      setTextOpacity(0)
    }else{
      setOpacity(1)
      const v = value - offset;
      const newTextOpacity = 1 - (textOffset - v)/textOffset;
